...
struct HotkeyBinding: Identifiable {
    ...
    var displayString: String {
        ...
        parts.append(KeyCodeHelper.getKeyName(keyCode: Int(keyCode)))
        return parts.joined()
    }
}
...
struct KeyEvent: Identifiable {
    ...
    var description: String {
        let keyName = KeyCodeHelper.getKeyName(keyCode: keyCode)
...
// MARK: - Key Code Helper (Nonisolated for struct access)
enum KeyCodeHelper {
    static func getKeyName(keyCode: Int) -> String {
        let keyNames: [Int: String] = [
            kVK_ANSI_A: "A", kVK_ANSI_B: "B", kVK_ANSI_C: "C", kVK_ANSI_D: "D",
            kVK_ANSI_E: "E", kVK_ANSI_F: "F", kVK_ANSI_G: "G", kVK_ANSI_H: "H",
            kVK_ANSI_I: "I", kVK_ANSI_J: "J", kVK_ANSI_K: "K", kVK_ANSI_L: "L",
